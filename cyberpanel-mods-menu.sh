...
show_main_menu() {
    while true; do
        ...
        echo -e "${WHITE}╠══════════════════════════════════════════════════════════════╣${NC}"
        echo -e "${WHITE}║                                                              ║${NC}"
        # Menu items with calculated padding accounting for emoji width (emojis are 2 chars visually)
        # Format: "║  " (3) + number (1-2) + ". " (2) + emoji+text + padding + "║" (1) = 62 total
        # Content width: 58 characters (62 - 3 - 1)
        printf "${WHITE}║  ${GREEN}%2d.${NC} ❌ Exit%48s${WHITE}║${NC}\n" 0 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 👥 User & Website Management%26s${WHITE}║${NC}\n" 1 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔍 OS Compatibility Check%29s${WHITE}║${NC}\n" 2 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🛠️  Utilities%39s${WHITE}║${NC}\n" 3 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔧 Core Fixes & Repairs%31s${WHITE}║${NC}\n" 4 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🛡️  Security Tools%34s${WHITE}║${NC}\n" 5 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🐘 PHP Version Manager%32s${WHITE}║${NC}\n" 6 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🗄️  MariaDB Version Manager%25s${WHITE}║${NC}\n" 7 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📦 Application Version Managers%23s${WHITE}║${NC}\n" 8 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 💾 Backup & Restore Tools%29s${WHITE}║${NC}\n" 9 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📧 Email Fixes%39s${WHITE}║${NC}\n" 10 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🖥️  OS-Specific Fixes%30s${WHITE}║${NC}\n" 11 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🌐 rDNS Tools%40s${WHITE}║${NC}\n" 12 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📚 Documentation%37s${WHITE}║${NC}\n" 13 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ℹ️  System Information%30s${WHITE}║${NC}\n" 14 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔄 Update Menu Script%32s${WHITE}║${NC}\n" 15 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ❌ Exit%47s${WHITE}║${NC}\n" 16 ""
        echo -e "${WHITE}║                                                              ║${NC}"
        echo -e "${WHITE}╚══════════════════════════════════════════════════════════════╝${NC}"
        echo -e ""
