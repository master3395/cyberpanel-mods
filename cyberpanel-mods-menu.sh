...
show_main_menu() {
    while true; do
        ...
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔧 Core Fixes & Repairs%*s${WHITE}║${NC}\n" 4 32 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🛡️  Security Tools%*s${WHITE}║${NC}\n" 5 38 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🐘 PHP Version Manager%*s${WHITE}║${NC}\n" 6 34 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🗄️  MariaDB Version Manager%*s${WHITE}║${NC}\n" 7 28 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📦 Application Version Managers%*s${WHITE}║${NC}\n" 8 23 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 💾 Backup & Restore Tools%*s${WHITE}║${NC}\n" 9 29 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📧 Email Fixes%*s${WHITE}║${NC}\n" 10 40 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🖥️  OS-Specific Fixes%*s${WHITE}║${NC}\n" 11 34 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🌐 rDNS Tools%*s${WHITE}║${NC}\n" 12 41 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📚 Documentation%*s${WHITE}║${NC}\n" 13 38 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ℹ️  System Information%*s${WHITE}║${NC}\n" 14 33 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔄 Update Menu Script%*s${WHITE}║${NC}\n" 15 33 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ❌ Exit%*s${WHITE}║${NC}\n" 16 47 ""
        echo -e "${WHITE}║                                                              ║${NC}"
        echo -e "${WHITE}╚══════════════════════════════════════════════════════════════╝${NC}"
        echo -e ""
