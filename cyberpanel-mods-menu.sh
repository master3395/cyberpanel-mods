...
show_main_menu() {
    while true; do
        ...
        printf "${WHITE}║  ${GREEN}%2d.${NC} ❌ Exit%44s${WHITE}║${NC}\n" 0 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 👥 User & Website Management%22s${WHITE}║${NC}\n" 1 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔍 OS Compatibility Check%25s${WHITE}║${NC}\n" 2 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🛠️  Utilities%33s${WHITE}║${NC}\n" 3 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔧 Core Fixes & Repairs%27s${WHITE}║${NC}\n" 4 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🛡️  Security Tools%28s${WHITE}║${NC}\n" 5 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🐘 PHP Version Manager%28s${WHITE}║${NC}\n" 6 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🗄️  MariaDB Version Manager%19s${WHITE}║${NC}\n" 7 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📦 Application Version Managers%19s${WHITE}║${NC}\n" 8 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 💾 Backup & Restore Tools%25s${WHITE}║${NC}\n" 9 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📧 Email Fixes%35s${WHITE}║${NC}\n" 10 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🖥️  OS-Specific Fixes%24s${WHITE}║${NC}\n" 11 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🌐 rDNS Tools%36s${WHITE}║${NC}\n" 12 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 📚 Documentation%33s${WHITE}║${NC}\n" 13 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ℹ️  System Information%24s${WHITE}║${NC}\n" 14 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} 🔄 Update Menu Script%28s${WHITE}║${NC}\n" 15 ""
        printf "${WHITE}║  ${GREEN}%2d.${NC} ❌ Exit%43s${WHITE}║${NC}\n" 16 ""
        echo -e "${WHITE}║                                                              ║${NC}"
        echo -e "${WHITE}╚══════════════════════════════════════════════════════════════╝${NC}"
        echo -e ""
